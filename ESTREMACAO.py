...
PROJECT_GID = os.getenv("ESTREMACAO_GID")
...
try:
    ...
    while True:
        ...
        for task in api_response:
            ...
            if section_info['position'] == 1:  # ESTUDO PRÉVIO
                situacao = "A Realizar"
            elif 2 <= section_info['position'] <= 14 or (section_info['position'] == 16): # Seções 2-14 e 16
    ...
    output_file = "ESTREMACAO_tarefas.xlsx"
    output_path = "\\SERVIDOR\Dashboard\Fonte de dados interna\ESTREMACAO_tarefas.xlsx"
