...
PROJECT_GID = os.getenv("UNIFICACAO_GID")
...
try:
    ...
    while True:
        ...
        for task in api_response:
            ...
            if section_info['position'] == 1:  # ESTUDO PRÉVIO
                situacao = "A Realizar"
            elif 2 <= section_info['position'] <= 6: # Seções 2-6
                situacao = "Em Execução"
            elif section_info['position'] in [8, 9] and is_completed:  # FINALIZADO E CONCLUÍDO
                situacao = "Finalizado"
            elif section_info['position'] in [8, 9] and not is_completed:  # FINALIZADO MAS NÃO CONCLUÍDO
    ...
    output_file = "UNIFICACAO_tarefas.xlsx"
    output_path = "\\SERVIDOR\Dashboard\Fonte de dados interna\UNIFICACAO_tarefas.xlsx"
