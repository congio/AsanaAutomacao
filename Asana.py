...
# Define o diretório do log na mesma pasta do .exe ou .py
...
log_e_print("="*50)
log_e_print("Iniciando execução do Asana.py")

# Lista de executáveis
EXECUTAVEIS = ["GEO-INCRA.exe", "ESTREMACAO.exe", "USUCAPIAO.exe", "UNIFICACAO.exe"]
